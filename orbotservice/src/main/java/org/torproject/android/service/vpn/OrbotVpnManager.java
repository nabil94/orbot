            ...
            public void run() {
                ...
                if (sSocksProxyServerPort == -1) {
                    try {
						...
						may have race with 3 other accesses.
						...
						1. in file, OrbotVpnManager.java, class OrbotVpnManager, method OrbotVpnManager, 
						
						sSocksProxyServerPort=-1
						
						2. with itself 
						
						3. in file, OrbotVpnManager.java, class ANON__OR__TYPE$Thread, method run, 
